...
var v = (o, e, t) => e in o ? _(o, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : o[e] = t;
var f = (o, e, t) => (v(o, typeof e != "symbol" ? e + "" : e, t), t);
!("requestVideoFrameCallback" in HTMLVideoElement.prototype) && "getVideoPlaybackQuality" in HTMLVideoElement.prototype && (HTMLVideoElement.prototype._rvfcpolyfillmap = {}, HTMLVideoElement.prototype.requestVideoFrameCallback = function(o) {
  const e = this.getVideoPlaybackQuality(), t = this.mozPresentedFrames || this.mozPaintedFrames || e.totalVideoFrames - e.droppedVideoFrames, s = (r, i) => {
    const h = this.getVideoPlaybackQuality(), c = this.mozPresentedFrames || this.mozPaintedFrames || h.totalVideoFrames - h.droppedVideoFrames;
    if (c > t) {
      const l = this.mozFrameDelay || h.totalFrameDelay - e.totalFrameDelay || 0, m = i - r;
      o(i, {
...
}, HTMLVideoElement.prototype.cancelVideoFrameCallback = function(o) {
  cancelAnimationFrame(this._rvfcpolyfillmap[o]), delete this._rvfcpolyfillmap[o];
});
String.prototype.startsWith || (String.prototype.startsWith = function(o, e) {
  return e === void 0 && (e = 0), this.substring(e, o.length) === o;
});
String.prototype.includes || (String.prototype.includes = function(o, e) {
  return this.indexOf(o, e) !== -1;
});
if (!ArrayBuffer.isView) {
  ...
  ArrayBuffer.isView = (e) => e && e.constructor && o.indexOf(e.constructor) !== -1;
}
Uint8Array.prototype.slice || (Uint8Array.prototype.slice = function(o, e) {
  return new Uint8Array(this.subarray(o, e));
});
...
if (typeof console > "u") {
  const o = (e, t) => {
    postMessage({
      target: "console",
      command: e,
      content: JSON.stringify(Array.prototype.slice.call(t))
    });
  };
  console = {
    log: function() {
...
const d = class extends EventTarget {
  /**
  ...
  static _test() {
    ...
    if (typeof ImageData.prototype.constructor == "function")
      try {
        ...
        console.log("detected that ImageData is not constructable despite browser saying so"), self.ImageData = function(h, c, l) {
    ...
    try {
      if (typeof WebAssembly == "object" && typeof WebAssembly.instantiate == "function") {
        ...
        i instanceof WebAssembly.Module && (d._supportsWebAssembly = new WebAssembly.Instance(i) instanceof WebAssembly.Instance);
      }
    } catch {
      d._supportsWebAssembly = !1;
    }
    ...
    d._hasAlphaBug = n[1] !== r[1], d._hasAlphaBug && console.log("Detected a browser having issue with transparent pixels, applying workaround"), e.remove(), s.remove();
  }
  /**
  ...
  resize(e = 0, t = 0, s = 0, a = 0, n = ((r) => (r = this._video) == null ? void 0 : r.paused)()) {
    if ((!e || !t) && this._video) {
      ...
      if (this._videoWidth) {
        ...
        h = this._computeCanvasSize((i.width || 0) / c, (i.height || 0) / l);
      } else
        h = this._computeCanvasSize(i.width || 0, i.height || 0);
      e = h.width, t = h.height, this._canvasParent && (s = i.y - (this._canvasParent.getBoundingClientRect().top - this._video.getBoundingClientRect().top), a = i.x), this._canvas.style.width = i.width + "px", this._canvas.style.height = i.height + "px";
    }
...
f(u, "_supportsWebAssembly", null), f(u, "_hasAlphaBug", null);
export {
  u as default
};
